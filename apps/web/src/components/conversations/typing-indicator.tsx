...
/**
 * Assistant-aligned "generating" affordance shown while a follow-up is being
...
export function TypingIndicator() {
  return (
    <div className="flex flex-col items-start gap-1">
      <div className="flex items-center gap-1.5 rounded-lg rounded-bl-sm border border-[var(--border-default)] bg-[var(--bg-surface-elevated)] px-4 py-3">
        {[0, 1, 2].map((i) => (
          <motion.span
            key={i}
